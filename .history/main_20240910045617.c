...
void one_hot_encode(unsigned char *labels, int num_labels, int *one_hot_matrix, int num_classes) {
...
int main(){
	...
	//one hot encoding
    float *one_hot_matrix = (float *)malloc(num_labels * num_classes * sizeof(float));
	one_hot_encode(labels, num_labels, )
